...
class ProgressViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var theLevels = [Level(levelNumber: 1, questNames: ["Switch off lights that are not needed or used","Reuse plastic bags","Say no to straws!"],questDescriptions:[
        ...
        Level(levelNumber: 11, questNames: ["Make a reusable bags from old t-shirts", "Make a recycled gift for a relative", "Put down your phone for a whole day!"], questDescriptions:["Isn't it such a waste when you have to throw away an old t-shirt you really liked? 'Goodbye, beautiful striped t-shirt I wore everyday', or 'Farewell old minecraft shirt I received for my birthday', right? Well, now you can give it a new purpose! By sowing it into a new bag for yourself, you not only avoid increasing your trash output, but you also get a free reusable bag of the same design as your favourite t-shirt! There are many tutorials on how to do this online. Go ahead and do your resesrch. Which style do you like the best?\nTask: Create a reusable bag out of old t-shirts. Take a picture of your cute new bag!",
            "Uh oh! Is it your relative's birthday? Did you forget to buy a gift? Well, no problem! Why not create one out of recycled materials you find around your house? There are many things lying around that we don't take note of... How about that box for the vacuum cleaner you ordered? Or those sheets of cardboard you have leftover? Well, now is a perfect time to use those! Even if it isn't their birthday, a little gift now and then wouldn't hurt. And why not kill two birds with one stone by recycling leftover materials to make a present? Think of what crafts you can make and get your creative juices flowing!\nTask: Create a gift out of recycled material for a relative. Take a picture of your creation!",
            "Ah... the information age. Nowadays, everyone is busy staying on their electronics, whether a brand new MacBook or your trusty IPhone. Why not go off your phone for a day? This helps to conserve electricity you use to charge your devices and also lets you breathe in the fresh air! Meanwhile, while you can't use your phone, why not do some other things? Read a book, go cycling... Anything! The world is awake and so are you! Take this time to enjoy life away from devices and appreciate nature.\nTask: Spend a whole day without using your phone. Take a screenshot of your battery level at the end of the day!"]),
        Level(levelNumber: 12, questNames: ["Visit a nature reserve", "Observe the biodiversity in your neighbourhood", "Use energy conserving light bulbs"], questDescriptions:["", "", ""]),
