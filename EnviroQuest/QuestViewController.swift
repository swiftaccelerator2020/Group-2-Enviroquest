...
class QuestViewController: UIViewController {
    ...
    let level2 = levelData(questNames: ["Take public transport instead!","Plant a seed", "Bring your own cutlery","Buy organic vegetables!", "Eat a vegetarian meal", "", "", ""],
        questInstructions:[
        ...
        "",
        ""
            //NEED THREE MORE QUESTS SORRY I CANNOT
        ])
