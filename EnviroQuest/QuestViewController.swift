...
class QuestViewController: UIViewController {
    ...
    let level2 = levelData(questNames: ["Take public transport instead!","Plant a seed", "Bring your own cutlery","Buy organic vegetables!", "Eat a vegetarian meal", "Go for a walk at a park", "Volunteer for a clean up", "Find the nearest recycling bin to your home"],
        questInstructions:[
    ...
    let level3 = levelData(questNames: ["Clear all your spam emails!", "Make art out of your trash!", "Go vegan for 3 days!", "Make a terrarium!", "Try to repair something", "Make a compost bin for your kitchen", "Measure your weekly trash output!", "Turn off appliances at the main sockets if they are not in use"], questInstructions: [
